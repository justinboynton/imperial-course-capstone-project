...
| Fn  | Dims | Description                    | Initial Best Y | Portal Best Y | Best Week | Improvement            |
| --- | ---- | ------------------------------ | -------------- | ------------- | --------- | ---------------------- |
...
| Kernel selector added to UI                         | W10           | All functions — per-function kernel choice (Matérn 5/2, 3/2, RQ, RBF) with session persistence   |
...
Justin Boynton [justin.boynton@gmail.com](mailto:justin.boynton@gmail.com)